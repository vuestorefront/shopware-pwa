<template>
  <div id="home">
    ...
    <SfBanner image="img/bannerD.png" class="banner-application desktop-only">
      <template #subtitle>
      ...
      <template #call-to-action>
        <div>
          <img class="banner-application__download" src="img/google.png" alt />
          <img class="banner-application__download" src="img/apple.png" alt />
        </div>
      </template>
    </SfBanner>
