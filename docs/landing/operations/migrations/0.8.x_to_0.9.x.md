...
But keep in mind that you will loose the compatibility with the config shipped in the core. It's always better to [report an issue](https://github.com/vuestorefront/shopware-pwa/issues/new/choose).
:::
