...
const createEqualsAnyFilter = (value: string[], field:string = "propertyIds"): EqualsAnyFilter => ({
 ...
 */
const extractFilter = (filterCode: string, filterData:any):  RangeFilter | EqualsFilter | EqualsAnyFilter | MultiFilter => {
...
export interface SwSorting {
  name: string, active: boolean, field: string, order: string
}
