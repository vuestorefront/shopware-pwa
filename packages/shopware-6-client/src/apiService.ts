...
import { responseInterceptor, errorInterceptor, requestInterceptor } from "./apiInterceptors";
...
apiService.interceptors.request.use(requestInterceptor, errorInterceptor);
